    ...
    [
      ...
      _c("my-card", { attrs: { _i: 14 } }, [
        ...
        _c(
          ...
          [
            _vm._$s(18, "i", _vm.tags[0])
              ? _c(
                  "view",
                  _vm._l(_vm._$s(19, "f", { forItems: _vm.tags }), function(
                    item,
                    index,
                    $20,
                    $30
      ...
      _c("my-card", { attrs: { _i: 21 } }, [
        ...
        _c(
          "view",
          {
            staticClass: _vm._$s(24, "sc", "tagBox"),
            attrs: { _i: 24 },
            slot: "cardContent"
          },
          [
            _vm._$s(25, "i", _vm.tags[0])
              ? _c(
                  "view",
                  _vm._l(_vm._$s(26, "f", { forItems: _vm.tags }), function(
                    item,
                    index,
                    $21,
                    $31
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _popup = _interopRequireDefault(__webpack_require__(/*! @/components/uni-popup/popup.js */ 22));\nvar _uniPopupDialog = _interopRequireDefault(__webpack_require__(/*! @/components/uni-popup/uni-popup-dialog.vue */ 26));\nvar _MyCard = _interopRequireDefault(__webpack_require__(/*! @/components/myCard/MyCard.vue */ 31));\nvar _MyTag = _interopRequireDefault(__webpack_require__(/*! @/components/myTag/MyTag.vue */ 36));\nvar _Mylist = _interopRequireDefault(__webpack_require__(/*! @/components/myList/Mylist.vue */ 42));\nvar _index = _interopRequireDefault(__webpack_require__(/*! @/mix/fun/index.js */ 47));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { components: { myCard: _MyCard.default, myList: _Mylist.default, myTag: _MyTag.default, uniPopupDialog: _uniPopupDialog.default }, mixins: [_index.default], data: function data() {return { money: '', // 记账金额\n      payAll: 200, // 支出统计总金额\n      income: 200000000, // 收入统计金额\n      tags: [], payList: [{ tags: ['信息项1', '信息项', '信息项', '信息项', '信息项'], time: '2020.10.10 13:13:13', number: 300 }, { tags: ['信息项2', '信息项', '信息项', '信息项', '信息项'], time: '2020.10.10 13:13:13', number: -200 }, { tags: ['信息项3', '信息项', '信息项', '信息项', '信息项'], time: '2020.10.10 13:13:13', number: 400 }], // 支出内容\n      incomeList: [], // 收入内容\n      tagTypeIndex: -1 // 标签类型索引\n    };}, onShow: function onShow() {// 重置金额\n    this.money = '';}, methods: { // 记账功能\n    record: function record() {if (this.money === '' || isNaN(+this.money)) {uni.showToast({ title: '请输入数字！', icon: 'none' });return false;}var money = +this.money;uni.navigateTo({ url: '/pages/record/index?money=' + money });}, // 跳转到详情页面\n    goDetail: function goDetail(type) {uni.navigateTo({ url: '/pages/detail/index' });}, // 添加标签弹窗\n    addTag: function addTag(index) {this.$refs.addTagPopup.open();this.tagTypeIndex = index;}, close: function close(done) {done();this.tagTypeIndex = -1;}, confirm: function confirm(done, val) {done();if (this.tagTypeIndex === -1 || !val) return false; // this.tags.push(val)\n      var apiArr = ['payTags/addTag', 'incomeTags/addTag'];var account = this.$store.getters['user/account'];var data = { tid: account + Date.now(), owner: account, content: val };this.$store.dispatch(apiArr[this.tagTypeIndex], data).then(function (res) {uni.showToast({ title: '添加成功！', icon: 'none' });});}, // 退出登录\n    logout: function logout() {var account = this.$store.getters['user/account'];this.$store.dispatch('user/logout', { account: account }).then(function (res) {uni.showToast({ title: '退出成功！', icon: 'none' });\n        uni.reLaunch({\n          url: '/pages/login/index' });\n\n      });\n    } } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///25\n");
            ...
            return _c(
              ...
              [
                _c(
                  ...
                  [
                    _vm._v(
                      _vm._$s("3-" + $30, "t0-0", _vm._s(item.tags.join("、")))
                    )
                  ]
                ),
                _c(
                  ...
                  [_vm._v(_vm._$s("4-" + $30, "t0-0", _vm._s(item.time)))]
                ),
                _c(
                  "view",
                  {
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c("button", {
        staticClass: _vm._$s(23, "sc", "save iconfont"),
        attrs: { _i: 23 },
        on: { click: _vm.save }
      })
    ]
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 89));\nvar _vuex = _interopRequireDefault(__webpack_require__(/*! vuex */ 94));\n\nvar _user = _interopRequireDefault(__webpack_require__(/*! ./modules/user.js */ 96));\nvar _incomeTags = _interopRequireDefault(__webpack_require__(/*! ./modules/incomeTags.js */ 102));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}\n\n_vue.default.use(_vuex.default);var _default =\n\nnew _vuex.default.Store({\n  modules: {\n    user: _user.default,\n    incomeTags: _incomeTags.default } });exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///93\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 97));var _user = __webpack_require__(/*! @/api/user.js */ 100);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err);}_next(undefined);});};}\n\n\n\n\nvar state = function state() {return {\n    account: '' };};\n\n\n// getters\nvar getters = {\n  account: function account(state) {return state.account;} };\n\n\n// actions\nvar actions = {\n  // 登录\n  login: function login(ctx, data) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:\n              (0, _user.login)(data).then(function (res) {\n                ctx.commit('SAVE_ACCOUNT', data.account);\n                return res;\n              }).catch(function (e) {return Promise.reject(e);});case 1:case \"end\":return _context.stop();}}}, _callee);}))();\n  },\n\n  // 注册\n  register: function register(ctx, data) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var result;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (\n                (0, _user.register)(data));case 2:result = _context2.sent;return _context2.abrupt(\"return\",\n              result);case 4:case \"end\":return _context2.stop();}}}, _callee2);}))();\n  },\n\n  // 退出\n  logout: function logout(ctx, data) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:\n              // 清除登录缓存\n              uni.removeStorageSync('account');\n              uni.removeStorageSync('password');\n              // 清楚仓库中账号\n              ctx.commit('REMOVE_ACCOUNT');case 3:case \"end\":return _context3.stop();}}}, _callee3);}))();\n  } };\n\n\n// mutations\nvar mutations = {\n  // 保存登录的账号\n  SAVE_ACCOUNT: function SAVE_ACCOUNT(state, account) {\n    state.account = account;\n  },\n\n  // 删除登录的账号\n  REMOVE_ACCOUNT: function REMOVE_ACCOUNT(state) {\n    state.account = '';\n  } };var _default =\n\n\n{\n  namespaced: true,\n  state: state,\n  getters: getters,\n  actions: actions,\n  mutations: mutations };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///96\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 97));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err);}_next(undefined);});};}var baseUrl = 'http://47.112.170.34:8082';\nvar withCredentials = false;function\n\nrequest() {return _request.apply(this, arguments);}function _request() {_request = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _ref,method,data,url,res,resData,_args = arguments;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_ref = _args.length > 0 && _args[0] !== undefined ? _args[0] : {}, method = _ref.method, data = _ref.data, url = _ref.url;\n            uni.showLoading({\n              title: '加载中' });_context.next = 4;return (\n\n              uni.request({\n                url: baseUrl + url,\n                method: method,\n                data: data,\n                withCredentials: withCredentials }));case 4:res = _context.sent;\n\n            uni.hideLoading();\n            resData = res[1].data;\n            // 请求失败\n            if (!(resData.code !== 200)) {_context.next = 10;break;}\n            uni.showToast({\n              title: resData.message,\n              icon: 'none' });return _context.abrupt(\"return\",\n\n            Promise.reject(resDate));case 10:return _context.abrupt(\"return\",\n\n            Promise.resolve(resData));case 11:case \"end\":return _context.stop();}}}, _callee);}));return _request.apply(this, arguments);}var _default =\n\n\nrequest;exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///101\n");

/***/ }),
/* 102 */
/*!************************************************************************!*\
  !*** E:/不可告人的···/h5 微信小程序/BookKeeping/app/store/modules/incomeTags.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 97));var _incomeTags = __webpack_require__(/*! @/api/incomeTags.js */ 103);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err);}_next(undefined);});};}\n\n\n\nvar state = function state() {return {\n    tags: [] };};\n\n\n// getters\nvar getters = {\n  tags: function tags(state) {return state.tags;} };\n\n\n// actions\nvar actions = {\n  // 添加标签\n  addTag: function addTag(ctx, data) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (\n                (0, _incomeTags.addTag)(data));case 2:res = _context.sent;return _context.abrupt(\"return\",\n              res);case 4:case \"end\":return _context.stop();}}}, _callee);}))();\n  } };\n\n\n// mutations\nvar mutations = {};var _default =\n\n{\n  namespaced: true,\n  state: state,\n  getters: getters,\n  actions: actions,\n  mutations: mutations };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///102\n");

/***/ }),
/* 103 */
/*!**************************************************************!*\
  !*** E:/不可告人的···/h5 微信小程序/BookKeeping/app/api/incomeTags.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.addTag = addTag;var _request = _interopRequireDefault(__webpack_require__(/*! @/common/request.js */ 101));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}\n\nfunction addTag(data) {\n  return (0, _request.default)({\n    url: '/incomeTags/addTag',\n    method: 'POST',\n    data: data });\n\n}//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///103\n");
